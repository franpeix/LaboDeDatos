...
df[['nombre']]
df.iloc[2]
df.iloc[2:6] #fila de la 2 a la 5
df.loc['78/23'] #acceder por el indice
df.loc['78/23', 'nombre'] #acceder por en indice en una columna especifica
df.sample() #me da una fila al azar
df.sample(n = 3) #me da n filas al azar¨
